...
<div class="content flex flex-col justify-center px-2 w-[100%] sm:w-[80%] space-x-1 sm:space-y-4 mx-auto">
    <div class="profile-detail w-[100%] flex flex-col justify-center space-y-4">
        ...
        <div class="profile-info flex items-center space-x-2 hidden sm:flex">
            <img src="{{asset('img/avt.jpg')}}" class="self-start w-[160px] h-[160px] rounded-full sm:block" alt="">
        ...
        <div class="profile-info flex items-center space-x-2 sm:hidden">
            <img src="{{asset('img/avt.jpg')}}" class="self-start w-[70px] h-[70px] rounded-full sm:block" alt="">
        ...
        <p class="overflow-x-clip line-clamp-2 text-[8px] sm:hidden">Orinn Music là đội ngũ sản xuất những dự án âm nhạc hàng đầu Việt Nam.</p>
        <button class="cursor-pointer hover:bg-slate-700 text-[12px] text-white bg-black font-semibold rounded-[30px] py-2 px-3 self-start w-[100%] sm:hidden">Đăng ký</button>
                    ...
                    <div class="group flex mt-3 w-[100%]">
                        ...
                        <div class="video-actions relative">
                            ...
                            <div class="dropdown absolute hidden bg-white right-5">
                                <div class="w-[200px] flex space-x-2 items-center px-4 py-1 hover:bg-slate-300 cursor-pointer text-[9px]">
                                ...
                                <div class="sharing-button w-[200px] flex space-x-2 items-center px-4 py-1 hover:bg-slate-300 cursor-pointer relative text-[9px]">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                                        <path d="M15 5.63 20.66 12 15 18.37V14h-1c-3.96 0-7.14 1-9.75 3.09 1.84-4.07 5.11-6.4 9.89-7.1l.86-.13V5.63M14 3v6C6.22 10.13 3.11 15.33 2 21c2.78-3.97 6.44-6 12-6v6l8-9-8-9z"></path>
                                    </svg>
                                    <span>Chia sẻ</span>
                                </div>
                                <div class="w-[200px] flex space-x-2 items-center px-4 py-1 hover:bg-slate-300 cursor-pointer mt-3 text-[9px]">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                ...
                <div class="w-[210px] flex flex-col items-center text-center">
                    ...
                    <div class="group flex mt-1 w-[100%]">
                        <div class="w-[calc(100%)] cursor-pointer flex flex-col space-y-2">
                            ...
                            <button class="self-center inline-block bg-slate-200 hover:bg-slate-300 px-3 py-1 text-[12px] text-semibold text-white rounded-l-full rounded-r-full">Đăng ký</button>
                        </div>
                    </div>
                </div>
            </li>
