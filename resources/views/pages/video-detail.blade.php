    ...
    <div class="main-grid w-[100%] gap-4">
        <div class="video-details flex flex-col space-y-2 self-start row-end-1">
            <div class="relative w-full h-0" style="padding-bottom: 56.25%;">
                <iframe class="absolute top-0 left-0 w-full h-full rounded-xl" src="https://www.youtube.com/embed/GX_f-LY4l9U" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            ...
            <div class="channel-description">
                ...
                <div class="channel-info flex flex-col md:flex-row md:justify-between md:items-center items-start">
                    ...
                    <div class="channel-profile flex justify-between space-x-2">
                        ...
                        <div class="cursor-pointer hover:bg-slate-700 text-[10px] sm:text-[12px] text-white bg-black font-semibold rounded-[30px] py-1 px-3 sm:py-2 sm:px-3 self-center">Đăng ký</div>
                    </div>

                    <div class="reactions flex justify-between items-center space-x-1">
                        <div class="like-dislike flex">
                            <button class="like flex items-center bg-slate-200 px-[2px] sm:px-2 rounded-l-full w-[65px] sm:w-[91px] sm:h-[36px] h-[32px] cursor-pointer hover:bg-slate-300 relative justify-center">
                            ...
                            <button class="dislike w-[38px] sm:h-[36px] h-[32px] flex items-center justify-center bg-slate-200 cursor-pointer hover:bg-slate-300 rounded-r-full">
                        ...
                        <button class="share-button flex sm:h-[36px] h-[32px] px-2 sm:px-3 space-x-2 rounded-l-full rounded-r-full justify-between items-center bg-slate-200 cursor-pointer hover:bg-slate-300">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                        ...
                        <div class="rounded-full main-video-action bg-slate-200 cursor-pointer hover:bg-slate-300 p-[4.5px] sm:p-[7px] relative">
            ...
            <div class="video-suggest flex flex-col space-y-2">
                <div class="video-item col-span-1 flex m-2 space-x-2">
                    <a href="/video-detail" class="h-[68px] w-[140px] sm:h-[94px] sm:w-[168px]">
                        <img class="rounded-lg hover:rounded-none cursor-pointer w-[100%] h-[100%]" src="{{asset('img/hq720.webp')}}" alt="" />
                    </a>
