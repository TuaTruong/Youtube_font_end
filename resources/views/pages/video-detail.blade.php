        ...
        <div class="main-grid w-[100%] gap-4">
            <div class="video-details flex flex-col space-y-2 self-start row-end-1">
                <div class="relative w-full h-0" style="padding-bottom: 56.25%;">
                    <iframe class="absolute top-0 left-0 w-full h-full rounded-xl"
                        src="https://www.youtube.com/embed/GX_f-LY4l9U" frameborder="0"
                ...
                <div class="channel-description">
                    ...
                    <div class="channel-info flex flex-col md:flex-row md:justify-between md:items-center items-start">
                        ...
                        <div class="reactions flex justify-between items-center space-x-1">
                            ...
                            <div
                                class="rounded-full main-video-action bg-slate-200 cursor-pointer hover:bg-slate-300 p-[7px] relative">
                                <svg xmlns="http://www.w3.org/2000/svg" class="button-dropdown" height="24"
                                    viewBox="0 0 24 24" width="24" focusable="false">
                                    <path
                ...
                <div class="video-description bg-[#f2f2f2] flex flex-col w-100% justify-start p-2 roundpxed-xl">
                    <div
                        class="views upload-time flex space-x-1 sm:space-x-3 font-semibold sm:text-[12px] text-[9px] no-wrap">
                    ...
                    <div class="video-item col-span-1 flex m-2 space-x-2">
                        ...
                        <div class="group flex w-[calc(100%-140px)] sm:w-[calc(100%-168px)]">
                            <div class="w-[calc(100%)] text-[10px] sm:text-[12px]">
                                <a class="line-clamp-2 overflow-hidden mb-1 text-[12px] sm:text-[14px]"
                                    href="/video-detail">
                            ...
                            <div class="video-actions relative">
                                ...
                                <div class="dropdown absolute hidden bg-white right-5">
                                    <div
                                        class="w-[200px] flex space-x-2 items-center px-4 py-1 hover:bg-slate-300 cursor-pointer">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                                            width="24" focusable="false">
                                    ...
                                    <div
                                        class="sharing-button w-[200px] flex space-x-2 items-center px-4 py-1 hover:bg-slate-300 cursor-pointer relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                                            width="24" focusable="false">
                                            <path
                                                d="M15 5.63 20.66 12 15 18.37V14h-1c-3.96 0-7.14 1-9.75 3.09 1.84-4.07 5.11-6.4 9.89-7.1l.86-.13V5.63M14 3v6C6.22 10.13 3.11 15.33 2 21c2.78-3.97 6.44-6 12-6v6l8-9-8-9z">
                                    ...
                                    <div
                                        class="w-[200px] flex space-x-2 items-center px-4 py-1 hover:bg-slate-300 cursor-pointer mt-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                                            width="24" focusable="false">
                                            <path
            ...
            <div class="comments-wrapper flex flex-col space-y-4 mt-8">
                ...
                <div class="write-comment flex w-[100%] space-x-3">
                    <img src="{{ asset('img\T.jpg') }}" width="40" height="40"
                    ...
                    <div class="viewer-comment flex space-x-3">
                        ...
                        <div class="flex flex-col w-[100%] justify-between space-y-2">
                            ...
                            <div class="flex space-x-2 items-center">
                                ...
                                <div
                                    class="response hover:bg-slate-200 cursor-pointer rounded-l-full rounded-r-full py-1 px-3">
                                    Phản hồi</div>
                            </div>
                        </div>
                    </div>
