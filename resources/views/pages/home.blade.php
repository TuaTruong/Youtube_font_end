...
@section('content')
    <div class="content-wrapper self-start h-[calc(100vh-70px)] overflow-y-auto">
        <ul class="suggest flex items-center justify-start no-wrap h-[45px] sm:h-[56px] overflow-x-auto m-2">
            <li
                class="text-[10px] sm:text-[14px] text-white bg-[#0f0f0f] px-4 py-1 rounded-lg mx-1 sm:mx-2 cursor-pointer whitespace-nowrap">
                Tất cả
            </li>
            <li
                class="text-[10px] sm:text-[14px] bg-[rgba(0,0,0,0.05)] px-4 py-1 rounded-lg mx-1 sm:mx-2 cursor-pointer whitespace-nowrap">
                Âm nhạc
            </li>
            <li
                class="text-[10px] sm:text-[14px] bg-[rgba(0,0,0,0.05)] px-4 py-1 rounded-lg mx-1 sm:mx-2 cursor-pointer whitespace-nowrap">
        ...
        <div
            ...
            <div class="video-item col-span-1 flex flex-col m-2">
                <a href="/video-detail" class="w-[100%]">
                    <img class="w-[100%] rounded-lg hover:rounded-none cursor-pointer" src="{{ asset('img/hq720.webp') }}"
                        alt="" />
                </a>
            ...
            <div class="short-container col-span-full row-start-3 row-end-4 inline-block w-[100%]">
                ...
                <div class="show-more-short text-center my-4 border-t-1 border-b-1 block relative">
                    <div
                        class="show-more-short-button border px-4 py-1 sm:px-16 sm:py-2 rounded-l-full rounded-r-full cursor-pointer bg-white hover:bg-slate-300 inline-block mx-auto no-wrap">
                        <span class="sm:mr-2 sm:text-sm text-[10px]">Hiện thêm</span>
                        <i class="ti-angle-down w-[10px] h-[10px]"></i>
                    </div>
                    <div
                        class="show-less-short-button hidden border px-4 py-1 sm:px-16 sm:py-2 rounded-l-full rounded-r-full cursor-pointer bg-white hover:bg-slate-300 inline-block mx-auto no-wrap">
