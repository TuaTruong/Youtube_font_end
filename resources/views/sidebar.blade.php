<div class="flex flex-col">
    <!-- Main sidebar  -->
    <div class="main-sidebar flex flex-col border-b-[1px] border-black pb-2 space-y-1">
        <div class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] bg-slate-200">
        ...
        <div class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-200">
    ...
    <!-- Me sidebar  -->
    <div class="me-sidebar flex flex-col border-b-[1px] border-black pb-2 my-2">
        <div class="flex items-center px-2 py-2 space-x-2 font-bold cursor-pointer rounded-[7px] hover:bg-slate-200">
        ...
        <div class="me-item flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-200">
        ...
        <div class="me-item hidden flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-200">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
        ...
        <div class="more-button flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-200">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                <path d="m18 9.28-6.35 6.35-6.37-6.35.72-.71 5.64 5.65 5.65-5.65z"></path>
            </svg>
            <span class="pt-1">Thêm</span>
        </div>
        <div class="less-button hidden flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-200">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
    ...
    <!-- Registered sidebar -->
    <div class="registered-sidebar flex flex-col border-b-[1px] border-black pb-2 my-2">
        <div class="flex items-center px-2 py-2 space-x-2 font-bold rounded-xl">
            <span class="pt-1">Kênh đăng ký</span>
        </div>
        <div class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-200">
    ...
    <!-- Explore sidebar -->
    <div class="explore-sidebar flex flex-col border-b-[1px] border-black pb-2 my-2">
    ...
    <!-- Youtube service  -->
    <div class="main-sidebar flex flex-col border-b-[1px] border-black pb-2 my-2">
        <div class="flex items-center px-2 py-2 space-x-2 font-bold">
