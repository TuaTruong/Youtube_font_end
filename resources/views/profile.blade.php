...
<body class="h-screen">
    ...
    <!-- SIDEBAR  -->
    <div class="mini-sidebar fixed w-[64px] h-screen mt-[62px] px-[4px] hidden sm:block bg-white pt-[18px]">
        <ul class="flex flex-col text-center space-y-2 cursor-pointer">
            <li class="w-[100%] flex flex-col py-[16px] hover:bg-[#ccc] rounded-lg space-y-1 justify-center items-center">
    ...
    <div class="big-sidebar w-[224px] p-2 mt-[62px] overflow-y-scroll max-h-[calc(100%-70px)] text-[13px] fixed bg-white pt-[18px] hidden xl:block">
        @include("sidebar")
    </div>
    <!-- End sidebar -->
