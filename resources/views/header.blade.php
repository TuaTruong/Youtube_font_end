<div class="flex items-center justify-between">
    ...
    <div class="header-center items-center justify-center mx-auto container hidden sm:inline-flex">
        ...
        <button class="w-[80px] h-[50.47px] bg-[#f8f8f8f8] rounded-r-full mr-4 hover:bg-[#ccc]">
            <i class="ti-search"></i>
        </button>

        <div class="py-3 px-4 rounded-full bg-[#f8f8f8] cursor-pointer hover:bg-[#ccc]">
            <i class="ti-microphone"></i>
        </div>
    </div>

    <!-- End header  -->
    <div class="end-header flex items-center font-serif text-sm header-end lg:space-x-2 xl:space-x-2 md:space-x-1">
        ...
        <div class="microphone-btn sm:hidden" aria-label="Tuan">
            <i class="ti-microphone cursor-pointer hover:bg-[#ccc] py-4 px-4 rounded-full"></i>
        </div>

        <div class="upload-btn relative" aria-label="Tuan">
            <i class="button-dropdown ti-video-camera cursor-pointer hover:bg-[#ccc] py-4 px-4 rounded-full"></i>
            <div class="dropdown absolute hidden w-40 mt-3 bg-white border shadow-md ti-video-camera-dropdown">
        ...
        <div class="notifications-wrapper relative" aria-label="Tuan">
            <i class="button-dropdown show-notifications ti-microphone cursor-pointer hover:bg-[#ccc] py-4 px-4 rounded-full"></i>
            <div class="dropdown absolute notification-scroll hidden w-[480px] border shadow-md bg-white top-8 right-8 max-h-[642px] overflow-y-auto">
        ...
        <div class="profile-wrapper w-[42px] h-[42px] relative">
            ...
            <div class="dropdown absolute hidden right-4 top-14 bg-white shadow-md w-[268px] font-sans">
                <div class="identifier flex items-center p-4 border-b-2">
                    <img src="{{asset('img/T.jpg')}}" width="42" height="42" class="rounded-full mr-4" />
