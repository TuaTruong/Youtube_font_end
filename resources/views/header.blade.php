<div class="flex items-center justify-between">
    ...
    <div class="end-header flex items-center font-serif text-sm header-end lg:space-x-2 xl:space-x-2 sm:space-x-1">
            ...
            <ul class="upload-dropdown dropdown absolute hidden w-40 mt-3 top-5 right-5 bg-white border ti-video-camera-dropdown">
                ...
                <li class="flex space-x-2 items-center p-2 cursor-pointer hover:bg-[#f8f8f8]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" focusable="false">
                        <path d="M15.01,7.34l1.64,1.64L8.64,17H6.99v-1.64L15.01,7.34 M15.01,5.92l-9.02,9.02V18h3.06l9.02-9.02L15.01,5.92L15.01,5.92z M17.91,4.43l1.67,1.67l-0.67,0.67L17.24,5.1L17.91,4.43 M17.91,3.02L15.83,5.1l3.09,3.09L21,6.11L17.91,3.02L17.91,3.02z M21,10h-1 v10H4V4h10V3H3v18h18V10z">
                        </path>
                    </svg>
                ...
                <li class="notification-item flex py-2 space-x-1 sm:py-4 sm:pr-4 justify-between cursor-pointer hover:bg-[#f8f8f8]">
                    ...
                    <div class="relative">
                        ...
                        <ul class="notification-item-dropdown dropdown absolute hidden right-5 bg-white">
                            <li class="w-[200px] sm:w-[350px] flex p-2 items-center cursor-pointer hover:bg-slate-200">
                                <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"  class="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px]" viewBox="0 0 24 24" focusable="false">
                                ...
                                <span class="text-[7px] sm:text-[14px]">Ẩn thông báo này</span>
                            </li>
                            <li class="w-[200px] sm:w-[350px] flex p-2 items-center cursor-pointer hover:bg-slate-200">
                                <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" focusable="false" class="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px]">
                                ...
                                <span class="text-[7px] sm:text-[14px]">Tắt tất cả những thông báo từ Tuyền Văn Hóa</span>
                            </li>
        ...
        <div class="profile-wrapper w-[25px] h-[25px] sm:w-[42px] sm:h-[42px] relative">
            ...
            <div class="change-account-dropdown sub-dropdown hidden dropdown absolute right-4 top-14 bg-white w-[240px] sm:w-[268px] font-sans">
            ...
            <div class="change-ui-dropdown hidden sub-dropdown dropdown absolute right-4 top-14 bg-white w-[240px] sm:w-[268px] font-sans">
                <div class="flex items-center p-2 border-b-2">
                    <i class="back-main-dropdown-button change-ui-button ti-arrow-left p-2 rounded-full hover:bg-slate-300 cursor-pointer"></i>
            ...
            <div class="change-language-dropdown hidden sub-dropdown dropdown absolute right-4 top-14 bg-white w-[240px] sm:w-[268px] font-sans">
                <div class="flex items-center p-2 border-b-2">
            ...
            <div class="change-restrict-mode-dropdown hidden sub-dropdown dropdown absolute right-4 top-14 bg-white w-[240px] sm:w-[268px] font-sans">
                <div class="flex items-center p-2 border-b-2">
            ...
            <div class="change-destination-dropdown hidden sub-dropdown dropdown absolute right-4 top-14 bg-white w-[240px] sm:w-[268px] font-sans">
                <div class="flex items-center p-2 border-b-2">
            ...
            <div class="main-profile-dropdown dropdown absolute hidden right-4 top-6 sm:top-14 bg-white w-[240px] sm:w-[268px] text-[12px] sm:text-sm  h-screen sm:h-[810px] font-sans overflow-y-auto">
                ...
                <div class="account-details flex flex-col border-b-2 mt-1">
                    <div class="flex cursor-pointer hover:bg-[#f0f0f0] py-2 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" focusable="false" class="my-1 mx-2">
                    ...
                    <div class="change-account-button flex cursor-pointer hover:bg-[#f0f0f0] py-2 items-center justify-between">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false" class="my-1 mx-2">
                    ...
                    <div class="flex cursor-pointer hover:bg-[#f0f0f0] py-2 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" class="my-1 mx-2">
                            <path d="M20 3v18H8v-1h11V4H8V3h12zm-8.9 12.1.7.7 4.4-4.4L11.8 7l-.7.7 3.1 3.1H3v1h11.3l-3.2 3.3z">
                            </path>
                        </svg>
                        <span>Đăng xuất</span>
                ...
                <div class="account-details flex flex-col border-b-2 mt-1">
                    ...
                    <div class="change-ui-button flex cursor-pointer hover:bg-[#f0f0f0] py-2 items-center justify-between">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24" focusable="false" class="my-1 mx-2">
                    ...
                    <div class="change-language-button flex cursor-pointer hover:bg-[#f0f0f0] py-2 items-center justify-between">
                        <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" class="my-1 mx-2">
