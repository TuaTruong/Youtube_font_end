<div class="flex items-center justify-between">
    ...
    <!-- Center header  -->
    <div class="header-center items-center justify-center mx-auto container hidden sm:inline-flex">
        <div class="input-search-bar p-3 space-x-2 border rounded-l-full w-[40%]">
            <i class="ti-search"></i>
        ...
        <button class="w-[12%] min-w-[50px] max-w-[80px]  h-[50.47px] bg-[#f8f8f8f8] rounded-r-full mr-4 hover:bg-[#ccc]">
            <i class="ti-search"></i>
        </button>
    ...
    <div class="end-header flex items-center font-serif text-sm header-end lg:space-x-2 xl:space-x-2 space-x-1">
        ...
        <div class="upload-wrapper relative" aria-label="Tuan">
            ...
            <div class="upload-dropdown dropdown absolute hidden w-40 mt-3 bg-white border ti-video-camera-dropdown">
                <div class="flex space-x-2 items-center p-2 cursor-pointer hover:bg-[#f8f8f8]">
        ...
        <div class="notifications-wrapper relative" aria-label="Tuan">
            <div class="group hover:bg-[#ccc] notification-button rounded-full p-3 button-dropdown cursor-pointer">
                ...
                <span class="w-[90px] group-hover:inline-block hidden absolute text-[13px] text-center top-14 right-[50%] translate-x-[50%] bg-slate-400 py-1 px-2 rounded-[3px]">Thông báo</span>
            </div>
            <div class="dropdown absolute notification-dropdown hidden w-[480px] border bg-white top-8 right-8 max-h-[642px] overflow-y-auto">
                ...
                <div class="notification-item flex py-4 pr-4 justify-between cursor-pointer hover:bg-[#f8f8f8]">
                    <div class="w-[4px]"></div>
                    <div>
                        <img width="48" height="48" src="{{asset('img/channel_profile.jpg')}}" class="rounded-full mr-2" />
                    </div>
                    ...
                    <div>
                        <i class="ti-more p-2 cursor-pointer hover:bg-[#ccc] rounded-full"></i>
                    </div>
                </div>
        ...
        <div class="profile-wrapper w-[42px] h-[42px] relative">
            ...
            <div class="change-ui-dropdown hidden sub-dropdown dropdown absolute right-4 top-14 bg-white w-[268px] font-sans">
                <div class="flex items-center p-2 border-b-2">
            ...
            <div class="main-profile-dropdown dropdown absolute hidden right-4 top-14 bg-white w-[268px] font-sans">
