<div class="flex flex-col">
    <!-- Main sidebar  -->
    <ul class="main-sidebar flex flex-col border-b-[1px] border-black pb-2 space-y-1">
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] bg-slate-100">
        ...
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
        ...
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            ...
            <span class="pt-1">Kênh đăng ký</span>
        </li>
    </ul>

    <!-- Me sidebar  -->
    <ul class="me-sidebar flex flex-col border-b-[1px] border-black pb-2 my-2">
        <li class="flex items-center px-2 py-2 space-x-2 font-bold cursor-pointer rounded-[7px] hover:bg-slate-100">
            <span class="pt-1">Bạn</span>
        ...
        <li class="me-item flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            ...
            <span class="pt-1">Kênh của bạn</span>
        </li>
        <li class="me-item flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                <g>
            ...
            <span class="pt-1">Video đã xem</span>
        </li>
        <li class="me-item flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                <path d="m10 8 6 4-6 4V8zm11-5v18H3V3h18zm-1 1H4v16h16V4z"></path>
            </svg>
            <span class="pt-1">Video của bạn</span>
        </li>
        <li class="me-item flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
            ...
            <span class="pt-1">Xem sau</span>
        </li>
        <li class="me-item hidden flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                <path d="M22 7H2v1h20V7zm-9 5H2v-1h11v1zm0 4H2v-1h11v1zm2 3v-8l7 4-7 4z"></path>
            </svg>
            <span class="pt-1">Tài chính</span>
        </li>
        <li class="me-item hidden flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                <path d="M22 7H2v1h20V7zm-9 5H2v-1h11v1zm0 4H2v-1h11v1zm2 3v-8l7 4-7 4z"></path>
            </svg>
            <span class="pt-1">Thế giới</span>
        </li>

        <li class="more-button flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                <path d="m18 9.28-6.35 6.35-6.37-6.35.72-.71 5.64 5.65 5.65-5.65z"></path>
            </svg>
            <span class="pt-1">Thêm</span>
        </li>
        <li class="less-button hidden flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                <path d="M18.4 14.6 12 8.3l-6.4 6.3.8.8L12 9.7l5.6 5.7z"></path>
            </svg>
            <span class="pt-1">Ẩn</span>
        </li>
    </ul>

    <!-- Registered sidebar -->
    <ul class="registered-sidebar flex flex-col border-b-[1px] border-black pb-2 my-2">
        <li class="flex items-center px-2 py-2 space-x-2 font-bold rounded-xl">
            <span class="pt-1">Kênh đăng ký</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <img src="{{asset('img/avt2.jpg')}}" width="24" height="24" alt="" class="rounded-full" />
            <span class="pt-1">Đen Vâu Ofical</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <img src="{{asset('img/avt1.jpg')}}" width="24" height="24" alt="" class="rounded-full" />
            <span class="pt-1">Web5ngay</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <img src="{{asset('img/avt3.jpg')}}" width="24" height="24" alt="" class="rounded-full" />
            <span class="pt-1">FreeCodeCamp</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <img src="{{asset('img/avt4.jpg')}}" width="24" height="24" alt="" class="rounded-full" />
            <span class="pt-1">Pinkfong</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <img src="{{asset('img/avt.jpg')}}" width="24" height="24" alt="" class="rounded-full" />
            <span class="pt-1">Review Phim</span>
        </li>
    </ul>

    <!-- Explore sidebar -->
    <ul class="explore-sidebar flex flex-col border-b-[1px] border-black pb-2 my-2">
        <li class="flex items-center px-2 py-2 space-x-2 font-bold">
            <span class="pt-1">Khám phá</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false">
            ...
            <span class="pt-1">Thịnh hành</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false">
        ...
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            ...
            <span class="pt-1">Thể thao</span>
        </li>
    </ul>

    <!-- Youtube service  -->
    <ul class="youtube-service-sidebar flex flex-col border-b-[1px] border-black pb-2 my-2">
        <li class="flex items-center px-2 py-2 space-x-2 font-bold">
            <span class="pt-1">Dịch vụ khác của youtube</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            ...
            <span class="pt-1">Youtube premium</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" focusable="false">
            ...
            <span class="pt-1">Youtube studio</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" focusable="false">
            ...
            <span class="pt-1">Youtube music</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" focusable="false">
            ...
            <span class="pt-1">Youtube kids</span>
        </li>
    </ul>

    <!-- Privacy and setting sidebar -->
    <ul class="privacy-sidebar flex flex-col border-b-[1px] border-black pb-2 my-2">
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            ...
            <span class="pt-1">Cài đặt</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" ><path d="m13.18 4 .24 1.2.16.8H19v7h-5.18l-.24-1.2-.16-.8H6V4h7.18M14 3H5v18h1v-9h6.6l.4 2h7V5h-5.6L14 3z"></path></svg>
            <span class="pt-1">Nhật ký báo cáo</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            ...
            <span class="pt-1">Trợ giúp</span>
        </li>
        <li class="flex items-center px-2 py-2 space-x-2 cursor-pointer rounded-[7px] hover:bg-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" ><path d="M13 14h-2v-2h2v2zm0-9h-2v6h2V5zm6-2H5v16.59l3.29-3.29.3-.3H19V3m1-1v15H9l-5 5V2h16z"></path></svg>
            <span class="pt-1">Gửi ý kiến phản hồi</span>
        </li>
    </ul>
