...
<body class="h-screen">
    <div class="wrapper grid grid-cols-2 grid-rows-2">
        <!-- HEADER  -->
        <div class="header-wrapper col-span-2 w-[100%] h-[40px] sm:h-[62px] p-1 sm:p-2 bg-white z-10 mr-1">
            @include("header")
        </div>
        <!-- END HEADER  -->
        ...
        <div class="big-sidebar w-[224px] p-2 overflow-y-scroll text-[13px] bg-white pt-[18px]">
            @include("sidebar")
        </div>
        <!-- End sidebar -->
        
        <div class="content-wrapper px-[10px]" style="display: inline-block">
